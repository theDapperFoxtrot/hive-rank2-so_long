...
SRC = error.c get_next_valid_line.c init_game_values.c is_playable.c main_so_long.c necessary_characters.c read_map.c validate_map.c load_textures.c render_foreground.c
OBJ = $(SRC:.c=.o)
LIBFT = libft/libft.a
